...
public class RippleView extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(com.andexert.library.R.styleable.RippleView_rv_color, ContextCompat.getColor(context, com.andexert.library.R.color.rippelColor));
