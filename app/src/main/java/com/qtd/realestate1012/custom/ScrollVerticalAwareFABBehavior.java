 ...
 */
public class ScrollVerticalAwareFABBehavior extends FloatingActionButton.Behavior {

    public ScrollVerticalAwareFABBehavior(Context context, AttributeSet attrs) {
        super();
    }
